...
export default class Home extends Component {
    ...
    getAllReplays(){
        fetch('http://127.0.0.1:5000/api/get-replays/'+String(this.props.userName), {
            method: 'GET',
    ...
    refreshReplays(filterino){
        fetch('http://127.0.0.1:5000/api/get-filtered-replays/'+String(this.props.userName)+'/'+filterino, {
            method: 'GET'
          }).then(response => response.json())
          .then(response => 
            {
    ...
    likeDislike(e){
        if(this.props.userName !== 'false' && this.props.userName !== false){
